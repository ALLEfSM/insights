...
public class OpiniaoController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Comentário cadastrado",
                    content = @Content(mediaType = "application/json",schema = @Schema(implementation = DetalhesOpiniao.class))),
    ...
    @ApiResponses(
            { @ApiResponse(responseCode = "200", description = "Opinião Atualizar com sucesso",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetalhesOpiniao.class))),
                    @ApiResponse(responseCode = "400", description = "Dados inválidos"),
                    @ApiResponse(responseCode = "404", description = "Comentário não encontrado")}
    )
    ...
    @ApiResponses(
            { @ApiResponse(responseCode = "200", description = "Opinião visualizada com sucesso",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetalhesOpiniao.class))),
                    @ApiResponse(responseCode = "400", description = "Dados inválidos"),
                    @ApiResponse(responseCode = "404", description = "Comentário não encontrado")}
    )
    ...
    @ApiResponses(
            { @ApiResponse(responseCode = "200", description = "Opinião recuperada com sucesso",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetalhesOpiniao.class))),
                    @ApiResponse(responseCode = "400", description = "Dados inválidos"),
                    @ApiResponse(responseCode = "404", description = "Comentário não encontrado")}
    )
