...
public class ClienteController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "informações Deletado",
    ...
    @ApiResponses(
            { @ApiResponse(responseCode = "200", description = "Cliente visualizado com sucesso",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetalhesCliente.class))),
                    @ApiResponse(responseCode = "400", description = "Dados inválidos"),
                    @ApiResponse(responseCode = "404", description = "informações não encontrado")}
    )
    ...
    @ApiResponses(
            { @ApiResponse(responseCode = "200", description = "Cliente recuperada com sucesso",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetalhesCliente.class))),
                    @ApiResponse(responseCode = "400", description = "Dados inválidos"),
                    @ApiResponse(responseCode = "404", description = "informações não encontrado")}
    )
