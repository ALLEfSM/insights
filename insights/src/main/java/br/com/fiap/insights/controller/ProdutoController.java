...
public class ProdutoController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Produto cadastrado",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetalhesProduto.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "informações Deletadas",
                    content = @Content(mediaType = "application/json",schema = @Schema(implementation = DetalhesProduto.class))),
            @ApiResponse(responseCode = "400", description = "Dados inválidos"),
    ...
    @ApiResponses(
            { @ApiResponse(responseCode = "200", description = "Produto visualizado com sucesso",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetalhesProduto.class))),
                    @ApiResponse(responseCode = "400", description = "Dados inválidos"),
                    @ApiResponse(responseCode = "404", description = "informações não encontrado")}
    )
    ...
    @ApiResponses(
            { @ApiResponse(responseCode = "200", description = "Produto recuperada com sucesso",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetalhesProduto.class))),
                    @ApiResponse(responseCode = "400", description = "Dados inválidos"),
                    @ApiResponse(responseCode = "404", description = "informações não encontrado")}
    )
